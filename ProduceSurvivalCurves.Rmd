...
The below cell finally patches the 3 graphs together into a single figure like that seen in the paper. We hope this code aids comparison between models for cancer recurrent event detection models.
